...
class Ui_login_window(object):
    def setupUi(self, login_window):
        ...
        icon1 = QIcon()
        icon1.addFile(u":/logo/img/lockdown.png",
                      QSize(), QIcon.Normal, QIcon.Off)
        login_window.setWindowIcon(icon1)
        self.actionOlvid_mi_contrase_a = QAction(login_window)
        self.actionOlvid_mi_contrase_a.setObjectName(
            u"actionOlvid_mi_contrase_a")
        self.actionRestaurar_base_de_datos = QAction(login_window)
        self.actionRestaurar_base_de_datos.setObjectName(
            u"actionRestaurar_base_de_datos")
        ...
        self.icon.setStyleSheet(
            u"background-image: url(:/logo/img/lockdown.png);")
        ...
        self.label.setStyleSheet(
            u"background-color: qlineargradient(spread:pad, x1:0.502, y1:0, x2:0.512, y2:1, stop:0 rgba(84, 94, 117, 255), stop:1 rgba(167, 204, 237, 255));")
    ...
    def retranslateUi(self, login_window):
        login_window.setWindowTitle(QCoreApplication.translate(
            "login_window", u"Lockdown", None))
        self.actionOlvid_mi_contrase_a.setText(QCoreApplication.translate(
            "login_window", u"Olvid\u00e9 mi contrase\u00f1a", None))
        self.actionRestaurar_base_de_datos.setText(QCoreApplication.translate(
            "login_window", u"Restaurar base de datos", None))
        self.user_input.setPlaceholderText("")
        self.login.setText(QCoreApplication.translate(
            "login_window", u"Iniciar sesi\u00f3n", None))
# if QT_CONFIG(shortcut)
        self.login.setShortcut(QCoreApplication.translate(
            "login_window", u"Return", None))
#endif // QT_CONFIG(shortcut)
        self.icon.setText("")
        self.user.setText(QCoreApplication.translate(
            "login_window", u"Usuario", None))
        self.password.setText(QCoreApplication.translate(
            "login_window", u"Contrase\u00f1a", None))
        self.label.setText("")
        self.opciones.setTitle(QCoreApplication.translate(
            "login_window", u"Opciones", None))
    # retranslateUi
