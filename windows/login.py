...
class Ui_login_window(object):
    def setupUi(self, login_window):
        ...
        icon1 = QIcon()
        icon1.addFile(
            u":/logo/img/lockdown.png", QSize(), QIcon.Normal, QIcon.Off
        )
        ...
        self.login.setStyleSheet(
            u"background-color: rgba(243, 201, 139,90);\n"
            "border: 1px solid white;\n"
            "border-radius: 10px;\n"
            ""
        )
    ...
    def retranslateUi(self, login_window):
        login_window.setWindowTitle(
            QCoreApplication.translate("login_window", u"Lockdown", None)
        )
        self.actionOlvid_mi_contrase_a.setText(
            QCoreApplication.translate(
                "login_window", u"Olvid\u00e9 mi contrase\u00f1a", None
            )
        )
        self.actionRestaurar_base_de_datos.setText(
            QCoreApplication.translate(
        ...
        self.login.setShortcut(
            QCoreApplication.translate("login_window", u"Return", None)
        )
        # endif // QT_CONFIG(shortcut)
        self.icon.setText("")
        self.user.setText(
            QCoreApplication.translate("login_window", u"Usuario", None)
        )
        ...
        self.label.setText("")
        self.opciones.setTitle(
            QCoreApplication.translate("login_window", u"Opciones", None)
        )
